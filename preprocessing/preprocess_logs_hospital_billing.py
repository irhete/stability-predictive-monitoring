...
# first labeling
dt_labeled = data.groupby(case_id_col).apply(check_if_attribute_exists, attribute="isCancelled", cut_from_idx=True)
dt_labeled.drop(['isCancelled'], axis=1).to_csv(os.path.join(output_data_folder, "hospital_billing_1.csv"), sep=";", index=False)
del dt_labeled    
...
# fourth labeling
dt_labeled = data.groupby(case_id_col).apply(check_if_attribute_has_value, attribute="closeCode", value="C", cut_from_idx=False)
dt_labeled.to_csv(os.path.join(output_data_folder, "hospital_billing_4.csv"), sep=";", index=False)
del dt_labeled

# fifth labeling
dt_labeled = data.groupby(case_id_col).apply(check_if_attribute_has_value, attribute="closeCode", value="A", cut_from_idx=False)
dt_labeled.to_csv(os.path.join(output_data_folder, "hospital_billing_5.csv"), sep=";", index=False)
del dt_labeled

# sixth labeling
dt_labeled = data.groupby(case_id_col).apply(check_if_attribute_has_value, attribute="closeCode", value="B", cut_from_idx=False)
dt_labeled.to_csv(os.path.join(output_data_folder, "hospital_billing_6.csv"), sep=";", index=False)
del dt_labeled
